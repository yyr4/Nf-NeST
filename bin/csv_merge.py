...
if CDS.empty:
        file = (Sample_name+"_merge"+'.csv')        # Create an empty file
        fb = open(file, "a")
        fb.write("HGVS.c,POS,ALT,CHROM,AA_change,Confidence,AVG_VAF,AVG_COV,REF,Sample_name,VARTYPE,Annotation,HGVS.p,VarCal,codon")     # Add header
        fb.close()
        #sys.exit()
